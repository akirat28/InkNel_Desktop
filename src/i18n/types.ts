...
export interface Locale {
  ...
  settings: {
    ...
    general: {
      ...
      editorActiveLineUnderline: string;
      editorActiveLineUnderlineDesc: string;
      editorActiveLineUnderlineColor: string;
      editorActiveLineUnderlineColorDesc: string;
      editorActiveLineUnderlineColorReset: string;
      editorHighlightActiveLineGutter: string;
      editorHighlightActiveLineGutterDesc: string;
      editorBracketMatching: string;
      editorBracketMatchingDesc: string;
      editorCloseBrackets: string;
      editorCloseBracketsDesc: string;
      editorTabSize: string;
      editorTabSizeDesc: string;
      historyMode: string;
